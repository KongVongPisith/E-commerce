...
export declare function expectResult<T>(result: FirebaseFunction.Result<T>): ExpectResult<T>;
export declare function expectHttpsError(execute: () => void, code: FunctionsErrorCode): void;
...
export declare class ExpectResult<T> {
    ...
    constructor(result: FirebaseFunction.Result<T>);
